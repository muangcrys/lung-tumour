...
def get_evaluate_parser():
    ...
    parser.add_argument('--skip_plot_loss', default=False, type='store_true', required=False)
    parser.add_argument('--skip_final_model', default=False, type='store_true', required=False)
    parser.add_argument('--skip_best_model', default=False, type='store_true', required=False)
